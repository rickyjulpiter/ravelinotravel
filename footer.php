                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-12">
                            <div class="footer-about footer-margin">
                                ...
                                <p>Your Link to The Best Traveling</p>
                        ...
                        <div class="col-md-3 col-sm-4">
                            <div class="footer-links-list footer-margin">
                                <h3>Our Service</h3>
                                <ul>
                                    <li><a href="#">Hotel Information<i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
                                    ...
                                    <li><a href="#">Car Rental Information <i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-4">
                ...
                <div class="row">
                    <div class="col-xs-6">
                        <div class="copyright-content">
                            <p>2019 <i class="fa fa-copyright" aria-hidden="true"></i> Synergi Ravelino Tours & Travel by <a href="https://www.sistempintar.com" target="_blank">Sistem Pintar</a></p>
                        </div>
                    </div>
                    <div class="col-xs-6">
