                                ...
                                <form role="form" method="POST" action="ubah-aksi" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <div>
                                                <?php
                                                    $query_mysql = mysqli_query($koneksi,"SELECT id,gambar FROM destinasi_area_gambar WHERE destinasi_area_id = '$idDestinasiArea' ")or die(mysqli_error());
                                                    $i=0;
                                                    ...
                                                    ?>
                                                    <img src="../../<?= $gambar?>"><br>
                                                    <a href="hapus-gambar?idGambar=<?=$idgambar?>&idDestinasiArea=<?= $idDestinasiArea?>" class="btn btn-danger">Hapus</a>
