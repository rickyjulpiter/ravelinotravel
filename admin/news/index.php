        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">News & Event</h1>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">News & Event List
                                    <span style="margin-left: 10px;"><a href="tambah" class="btn btn-info btn-xs">+ Add New</a></span>
                                </h3>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo $nama; ?></td>
                                                <!--<td><?php //echo $deskripsiDestinasi; 
                                                        ?></td>
                    <td><?php //echo $gambarDestinasi; 
                        ?></td>-->
                                                <td>
