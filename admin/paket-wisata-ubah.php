        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Ubah Detail Paket Wisata</h1>
                        </div>
                    </div>
                </div>
                <!-- /.container-fluid -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-info">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form role="form" method="POST" action="paket-wisata-ubah-aksi" enctype="multipart/form-data">
                                	<?
                                	$queryDetailPaket = mysqli_query($koneksi,"SELECT * FROM paket_wisata A, jenis_paket B WHERE A.jenis_paket = B.id_paket AND A.id_wisata = '$id_paket'");
                                    $d = mysqli_fetch_assoc($queryDetailPaket);
                                    $id = $d['id_wisata'];
                                    $nama = $d['nama_wisata'];
                                    $deskripsi = $d['deskripsi_wisata'];
                                    $harga = $d['harga_wisata'];
                                    $fasilitas = $d['fasilitas_wisata'];
                                    $jenis = $d['nama_paket'];
                                    $gambar = $d['gambar_wisata'];
									?>
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="harga" type="number" class="form-control" id="exampleInputEmail1" value="<?php echo $harga; ?>">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                ...
                                                if ($gambar == '') {
                                                    ...
                                                    echo "<label>Gambar Paket Wisata Saat Ini</label><br>";
                                                }
                                                ?>
                                    ...
                                    <div class="card-footer">
                                        <button type="submit" class="btn btn-block btn-info">Ubah Data Paket</button>
                                    </div>
                                </form>
                            </div>
                            <!-- /.card -->
