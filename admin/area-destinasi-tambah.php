        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Tambah Area Destinasi Wisata</h1>
                        </div>
                    </div>
                </div>
                <!-- /.container-fluid -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-info">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form role="form" method="POST" action="area-destinasi-tambah-aksi.php" enctype="multipart/form-data">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Nama Area Destinasi Wisata</label>
                                            <input name="nama_wisata" type="text" class="form-control" id="exampleInputEmail1" required="">
                                        </div>
                                        <div class="form-group">
                                        	<label for="exampleInputPassword1">Deskripsi Area Destinasi Wisata</label>
                                        	<!-- tools box -->
                                    ...
                                    <div class="card-footer">
                                        <button type="submit" class="btn btn-block btn-info">Tambah Area Wisata</button>
                                    </div>
                                </form>
                            </div>
                            <!-- /.card -->
