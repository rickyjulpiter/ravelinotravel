                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-info">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form role="form" method="POST" action="jenis-paket-ubah-aksi" enctype="multipart/form-data">
                                	<?
                                	$data = mysqli_query($koneksi,"SELECT * FROM jenis_paket WHERE id_paket = '$id_paket'");
									while($d = mysqli_fetch_array($data)){
									?>
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Nama Paket</label>
                                            <input name="nama" type="text" class="form-control" id="exampleInputEmail1" value="<?php echo $d['nama_paket']; ?>">
                                        ...
                                        <div class="form-group">
					                        ...
					                        <div class="pad">
					                         	<div class="">
					                         		<textarea name="deskripsi" class="textarea" style="width: 100%; height: 400px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $d['deskripsi_paket']; ?>
					                                </textarea>
					                            </div>
					                        </div>
					                           <!-- /. tools -->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                ...
                                                if ($d['gambar_paket'] == '') {
                                                    ...
                                                    echo "<label>Gambar Saat Ini</label><br>";
                                                }
                                                ?>
                                                <img src="<?php echo "../".$d['gambar_paket']; ?>" width="30%" style="<?php echo($tampakGambar); ?>">
