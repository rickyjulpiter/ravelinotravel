            ...
            <div class="row">
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="package-item">
                        ...
                        <div class="package-content">
                            <h3><a href="tour-area"  style="color: green">Brastagi, North Sumatra</a></h3>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="package-item">
                        ...
                        <div class="package-content">
                            <h3><a href="tour-area"  style="color: green">Dua Island, Aceh</a></h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="package-item">
                        ...
                        <div class="package-content">
                            <h3><a href="tour-area"  style="color: green">Asok Island, Aceh</a></h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="package-item">
                        ...
                        <div class="package-content">
                            <h3><a href="tour-area"  style="color: green">Balai Island, Aceh</a></h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="package-item">
                        ...
                        <div class="package-content">
                            <h3><a href="tour-area"  style="color: green">Balong Island, Aceh</a></h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="package-item">
                        ...
                        <div class="package-content">
                            <h3><a href="tour-area"  style="color: green">Bangkaru Island, Aceh</a></h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod.</p>
                        </div>
                    </div>
                </div>
