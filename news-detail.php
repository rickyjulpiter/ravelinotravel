...
<body>
    ...
    <!-- Navigation Bar Ends -->
    <?php
    $queryTour = mysqli_query($koneksi, "SELECT * FROM news WHERE id = '$id '") or die(mysqli_error());
            ...
            <div class="row">
                <div id="content" class="col-md-8">
                    <div class="detail-content content-wrapper">
                        <div>
                            <img src="<?php echo $gambar; ?>" style="height:70%;width:55%;">
                        </div>
                        <br>
